...
export function MetasPage(){
 ...
 if(!canonical)return <PanelPage title="Metas"><PanelEmptyState icon="◎" title="Base ainda não carregada" description="Carregue Bússola e Roteiro em Configurações para iniciar a manutenção das metas."/></PanelPage>;
