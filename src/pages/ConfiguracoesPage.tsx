...
export function ConfiguracoesPage(){
  ...
  return <PanelPage title="Atualizar Bases" metricLabel="Fontes válidas" metricValue={`${validCount}/19`}>
    {activeCanonical?<PanelAlert tone="success">Build ativo: {activeCanonical.motorBuildId}<br/>Atualize somente os relatórios que mudaram; os demais stagings válidos serão reutilizados. Quando uma regra do motor for atualizada, use Reprocessar motor atual sem reenviar arquivos.</PanelAlert>:<PanelAlert tone="info">Primeira carga: selecione as 19 fontes originais. Depois disso, cada atualização pode substituir apenas as fontes que mudaram.</PanelAlert>}
