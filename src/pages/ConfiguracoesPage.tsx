...
const qualityAction = (code: string) => {
  if (code === 'INBOUND_ITEM_UNRESOLVED' || code === 'SALES_ITEM_UNRESOLVED' || code === 'STOCK_105_CODE_NOT_IN_ITEM_MASTER') return 'Atualize o Cadastro de Itens 286 e reprocese o lote.';
  if (code === 'INDUSTRIAL_PACK_MISSING') return 'Atualize a Lista de Preço Colgate com o Un/CX industrial e reprocese o lote.';
  if (code === 'SALES_RCA_NOT_OFFICIAL') return 'Atualize o De-Para / Novos RCAs e reprocese o lote.';
  return 'Revise a fonte indicada e reprocese o lote.';
};
