...
const m2={...base,id:'M2_CLIENTE_RCA' as const,records:[{cnpj:'00000000000001',top_network:'A',top_route_competence:'2026-08',top_target:100},{cnpj:'00000000000002',premise_network:'FORA'}]};
