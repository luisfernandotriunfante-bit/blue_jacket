...
test('TOP REDES aplica percentual validado em G H K L inclusive em estilo com aplicação desativada', () => {
  ...
  assert.match(workbookSource, /currentApplyNumberFormat/);
  assert.match(workbookSource, /currentNumFmtId === numFmtId && currentApplyNumberFormat === applyNumberFormat/);
});
