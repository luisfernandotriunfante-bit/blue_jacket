...
const m2 = { ...base, id: 'M2_CLIENTE_RCA' as const, records: [
  { cnpj: '00111111000100', top_network: 'REDE A', top_target: 500, premise_network: 'OUTRA TAXONOMIA' },
  { cnpj: '00222222000100', top_network: 'REDE A', top_target: 300 },
...
test('Redes usa somente CNPJs do Roteiro Ativo e exclui redes de Premissas fora do roteiro', () => {
...
test('Meta da rede preserva Meta Redes Geral e usa representatividade do Roteiro referenciada por Meta T&C / Meta Indústria', () => {
  const multiM2 = { ...m2, records: [
    { cnpj: '00111111000100', top_network: 'REDE A', top_target: 500 },
    { cnpj: '00222222000100', top_network: 'REDE B', top_target: 300 },
  ] };
